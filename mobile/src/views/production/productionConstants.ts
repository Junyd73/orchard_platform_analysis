...
export const MSG_HARVEST_EMPTY = '선택한 기간에 수확 기록이 없습니다.'
export const MSG_HARVEST_RANGE_REQUIRED = '조회 기간을 입력해 주세요.'
export const MSG_HARVEST_RANGE_INVALID = '시작일은 종료일보다 늦을 수 없습니다.'
