...
export const LABEL_SEASON_TYPE = '시즌구분'
export const LABEL_PREPAY = '선입금액'
export const LABEL_PREPAY_METHOD = '결제수단'
export const PREPAY_METHOD_ACCT_PREFIX = 'AS0101'
export const PREPAY_METHOD_ACCT_LEVEL = 4
export const MSG_PREPAY_METHOD_REQUIRED = '선입금이 있으면 결제수단을 선택해 주세요.'
...
export const CODE_PARENT_SEASON = 'SS01'
/** 신규 주문 기본값 — hydrate 시 레거시 blank에 적용 금지 */
export const DEFAULT_SALES_TYPE_CD = 'SA010100'
