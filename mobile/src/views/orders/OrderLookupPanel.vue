...
const statusCd = defineModel<string>('statusCd', { default: '' })
...
<template>
  <OdsCard class="lookup" aria-label="조회조건">
    <div class="lookup-summary">
      ...
      <button
        ...
        aria-controls="order-lookup-body"
    ...
    <div v-show="expanded" id="order-lookup-body" class="lookup-body">
