...
> **현재 기준 (2026-08-23):** private main **Stage6-0·6A 반영** · Stage6B **feature 진행** · 운영 backend **`b48ca8b`**(Stage5).  
...
> **Stage6B:** 수금내역 GET + Mobile read-only — **완료 · feature · main 미반영**.  
> **다음:** Stage6 **6C 수금등록**.  
...
| — | Stage6B 수금내역 read-only | **완료 · feature · main 미반영** |
| — | **다음:** Stage6 **6C 수금등록** | [§ 2026-08-21](#2026-08-21--선입금수금-정책-확정) |
...
6B 수금내역 read-only  ← 완료 · feature · main 미반영
6C 수금등록  ← 다음
7  PC 정합성
...
| 6B | **수금내역 read-only** | **완료 · feature · main 미반영** | `GET /sales/{sales_no}/payments` · cash 행 SSOT · GENERAL/ORDER_PREPAY · method명 · SELECT only | 6A |
| 6C | **수금등록** | **예정** | 수금액 ≤ 미수금 · 결제수단 필수 · pay_dt 정책 확정 후 | 6B |
