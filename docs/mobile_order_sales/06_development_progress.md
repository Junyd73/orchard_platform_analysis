...
> **다음:** Stage7A **PC 출고확정 판매 보호** (feature) → Stage7B PC 수금 공용화.  
...
| — | Stage7A PC 출고확정 판매 보호 | **진행 · feature · main 미반영 · 운영 미배포** |
| — | **다음:** Stage7B PC 수금/회계 SalesPaymentService 공용화 | [08 A13](./08_pc_change_scope.md) · [07 DEC-031/032](./07_decisions.md#dec-031) |
...
7A PC 출고확정 판매 보호  ← 진행 · feature · main 미반영
7B PC 수금/회계 공용화  ← 다음
...
| 7A | **PC 출고확정 판매 보호** | **진행 · feature · main 미반영 · 운영 미배포** | DEC-031: CONFIRMED + (`order_no` \| `order_detail_id` \| `stock_seq`) → PC read-only · UI disable + save/delete backstop | 6C |
