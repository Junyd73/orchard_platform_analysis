...
| — | **다음:** Stage6 **6A 판매상세 read-only** | [§ 2026-08-21](#2026-08-21--선입금수금-정책-확정) |
...
| 6 | **판매상세/수금등록** | **예정** (6A→6B→6C) | 6A 상세 read-only → 6B 수금내역 → 6C 수금등록(수금액 ≤ 미수금, 결제수단 필수) | 6-0 |
