...
> **현재 기준 (2026-08-23):** private main **Stage6-0·6A·6B·6C 반영** · 운영 backend **`b48ca8b`**(Stage5).  
...
> **Stage7B-2:** PC 신규수금 append (`SalesPaymentService.add_payment`) — **진행 · feature · main 미반영 · 운영 미배포**.  
> **DEC-031:** **APPROVED · IMPLEMENTED**. **DEC-032:** **APPROVED · Stage7B-1 immutable + Stage7B-2 append**. **DEC-033/034:** **APPROVED · IMPLEMENTED**.  
> **다음:** Stage7B-2 cross-review → private main 병합.  
...
| — | Stage7B-2 PC 신규수금 append | **진행 · feature · main 미반영 · 운영 미배포** |
| — | **다음:** Stage7B-2 cross-review | [08 A13](./08_pc_change_scope.md) · [07 DEC-032](./07_decisions.md#dec-032) |
...
7B-2 PC 신규수금 append  ← 진행 · feature · main 미반영
...
| 7B-2 | **PC 신규수금 append** | **진행 · feature · main 미반영 · 운영 미배포** | `SalesPaymentService.add_payment` · DEC-030 · `list_payment_methods` SSOT · protected CONFIRMED도 unpaid>0 이면 add 허용 | 7B-1 |
