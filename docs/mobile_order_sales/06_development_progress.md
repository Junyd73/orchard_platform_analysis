...
| 5 | **판매목록** | **feature 완료 · main/운영 미반영** | `SalesQueryService` + `GET /sales` + Mobile 판매탭 2줄 목록·ODS 조회패널. cash SUM SSOT · 판매/수금 배지 분리 · DDL 0 | Stage4 운영 완료 |
