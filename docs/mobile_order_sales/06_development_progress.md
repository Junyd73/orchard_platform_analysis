...
| — | **다음:** Stage5 review → main merge·운영 · 6 판매상세/수금 | [§ 2026-08-21](#2026-08-21--선입금수금-정책-확정) |
...
3  판매 수금 Core        ← 완료 · 운영
4  출고 시 선입금 자동배분  ← 완료 · 운영
5  판매목록  ← feature + P1 보완 · main/운영 미반영
6  판매상세/수금등록
7  PC 정합성
...
| 5 | **판매목록** | **feature + P1 보완 · main/운영 미반영** | `SalesQueryService` + `GET /sales` + Mobile 판매탭. P1: 수금 filter 상호배타·malformed date 400. cash SUM SSOT · DDL 0 | Stage4 운영 완료 |
