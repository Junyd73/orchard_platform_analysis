...
> **Stage7B-1:** PC 수금 immutable + full-save cash/ledger 제거 — **진행 · feature · main 미반영 · 운영 미배포**.  
> **DEC-031:** **APPROVED · IMPLEMENTED**. **DEC-032:** **APPROVED · Stage7B-1 일부 구현**. **DEC-033/034:** **APPROVED**.  
...
| — | Stage7B-1 PC 수금 immutable | **진행 · feature · main 미반영 · 운영 미배포** |
...
7B-1 PC 수금 immutable  ← 진행 · feature · main 미반영
...
| 7B-1 | **PC 수금 immutable** | **진행 · feature · main 미반영 · 운영 미배포** | DEC-032/033/034: full-save cash/ledger mutation 제거 · 기존 수금 read-only · DEC-034 감액 backstop · cash 있는 판매 delete 차단 | 7A |
| 7B-2 | **PC 신규수금 append** | **예정 · 미착수** | `SalesPaymentService.add_payment` UI 연결 · DEC-030 | 7B-1 |
| 7B | **PC 수금/회계 공용화 (잔여)** | **예정 · 미착수** | `order_detail_id` 재저장 보존 · PC↔모바일 수금계약 ([08 A13](./08_pc_change_scope.md)) | 7B-2 |
