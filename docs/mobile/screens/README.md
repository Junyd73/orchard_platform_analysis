# SCR Screens (Approved)

승인된 화면 명세. **배치·색·간격·컴포넌트를 임의로 변경하지 않는다.**  
공통 정책: `mobile/docs/ODS/ODS_v1.md` (**Active v1.2.2**, 포함 v1.1.1 · v1.2 · v1.2.1).  
버전 SSOT: [`../VERSIONS.md`](../VERSIONS.md)
...
| SCR-012 | 알림 | **In progress · Phase 1** | [SCR-012.md](./SCR-012.md) |
