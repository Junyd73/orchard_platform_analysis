...
class ClickCounterWidget(QFrame):
    ...
    def init_ui(self):
        ...
        self.lbl_stock.setStyleSheet(MainStyles.CARD_LBL_STYLE + f" font-size: 10px; color: {color};")
        ...
        self.lbl_value.setStyleSheet(MainStyles.LBL_TABLE_SUB + " font-size: 20px; font-weight: 900; color: #2D3748;")
    ...
    def update_display(self):
        ...
        self.lbl_value.setStyleSheet(MainStyles.LBL_TABLE_SUB + f" font-size: 22px; font-weight: 900; color: {color};")
...
class CustomerRegistrationPopup(QDialog):
    ...
    def init_ui(self, name, mobile):
        ...
        # 라벨 스타일 함수 (MainStyles.CARD_LBL_STYLE 기반)
        def lbl(text):
            l = QLabel(text)
            l.setStyleSheet(MainStyles.CARD_LBL_STYLE + " font-size: 14px;")
            return l
...
class StockMatrixPopup(QDialog):
    ...
    def make_lbl(self, text):
        l = QLabel(text); l.setStyleSheet(MainStyles.CARD_LBL_STYLE); return l
...
class OrderManagementPage(QWidget):
    ...
    def setup_left_panel(self):
        ...
        def _lbl(text):
            l = QLabel(text)
            l.setStyleSheet(MainStyles.CARD_LBL_STYLE)
            return l
        ...
        self.lbl_master_count.setStyleSheet(MainStyles.CARD_LBL_STYLE)
    ...
    def setup_center_panel(self):
        ...
        lbl_cust.setStyleSheet(MainStyles.CARD_LBL_STYLE)
        ...
        self.btn_cust_search.setFixedWidth(70)
        ...
        self.detail_balance_lbl.setStyleSheet(MainStyles.LBL_TEXT_RIGHT_LIGHT + " color: #E53E3E; font-size: 14px; padding-right: 5px;")
        ...
        self.bridge_price_year = QSpinBox() # (기존 bridge_price_year 유지)
    ...
    def initiate_new_order(self):
        ...
        self.detail_balance_lbl.setStyleSheet(MainStyles.LBL_TEXT_RIGHT_LIGHT + " color: #3182CE; font-size: 12px;") 
    ...
    def update_master_amounts(self):
        ...
        try:
            ...
            self.detail_balance_lbl.setStyleSheet(MainStyles.LBL_TEXT_RIGHT_LIGHT + f" color: {color}; font-size: 13px;")
        except:
    ...
    def setup_right_panel(self):
        ...
        lbl_main_title.setStyleSheet(MainStyles.LBL_TITLE)
        ...
        base_lay.addWidget(QLabel("대상 품목", styleSheet=MainStyles.CARD_LBL_STYLE), 0, 0)
        base_lay.addWidget(self.combo_delivery_target, 0, 1)
        base_lay.addWidget(QLabel("예정 일자", styleSheet=MainStyles.CARD_LBL_STYLE), 0, 2)
        ...
        sender_lay.addWidget(QLabel("성함", styleSheet=MainStyles.CARD_LBL_STYLE), 0, 0); sender_lay.addWidget(self.edit_snd_nm, 0, 1)
        sender_lay.addWidget(QLabel("연락처", styleSheet=MainStyles.CARD_LBL_STYLE), 0, 2); sender_lay.addWidget(self.edit_snd_tel, 0, 3)
        sender_lay.addWidget(QLabel("주소", styleSheet=MainStyles.CARD_LBL_STYLE), 1, 0); sender_lay.addWidget(self.edit_snd_addr, 1, 1, 1, 3)
        ...
        rcv_lay.addWidget(QLabel("받는분", styleSheet=MainStyles.CARD_LBL_STYLE), 0, 0); rcv_lay.addWidget(self.edit_rcv_nm, 0, 1)
        rcv_lay.addWidget(QLabel("연락처", styleSheet=MainStyles.CARD_LBL_STYLE), 0, 2); rcv_lay.addWidget(self.edit_rcv_tel, 0, 3)
        rcv_lay.addWidget(QLabel("수량", styleSheet=MainStyles.CARD_LBL_STYLE), 1, 0); rcv_lay.addWidget(self.edit_rcv_qty, 1, 1)
        rcv_lay.addWidget(QLabel("주소", styleSheet=MainStyles.CARD_LBL_STYLE), 1, 2); rcv_lay.addWidget(self.edit_rcv_addr, 1, 3)
        rcv_lay.addWidget(QLabel("메시지", styleSheet=MainStyles.CARD_LBL_STYLE), 2, 0); rcv_lay.addWidget(self.edit_rcv_msg, 2, 1, 1, 3)
        ...
        combined_style = MainStyles.TABLE + f"\nQTableWidget::item {{ {MainStyles.LBL_TABLE_SUB} }}"
        self.table_delivery_plan.setStyleSheet(combined_style)
