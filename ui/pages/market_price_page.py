...
from ui.styles import DEFAULT_FONT_FAMILY, MainStyles, make_app_font
...
MARKET_ANALYSIS_STATUS_LBL_STYLE = (
    f"color:#4A5568; border:none; background:transparent;"
    f"font-size:9pt; font-family:'{DEFAULT_FONT_FAMILY}';"
)
MARKET_ANALYSIS_LATEST_LBL_STYLE = (
    f"color:#718096; border:none; background:transparent;"
    f"font-size:9pt; font-family:'{DEFAULT_FONT_FAMILY}';"
)
...
CHART_HOVER_TIP_STYLE = (
    ...
    f"border: 1px solid #E2E8F0; padding: 6px; font-size: 9pt; "
...
_QAXIS_QLABEL_FONT = (
    f"font-family:'{DEFAULT_FONT_FAMILY}'; font-size:{CHART_AXIS_LABEL_FONT_PT}pt; font-weight:normal;"
)
...
STRUCTURE_CHART_LEGEND_HTML = (
    f'<div style="font-family:\'{DEFAULT_FONT_FAMILY}\'; font-size:8pt; color:#718096;">'
...
ANALYSIS_STRUCTURE_LEGEND_LABEL_STYLE = (
    f"font-family:'{DEFAULT_FONT_FAMILY}'; font-size:8pt; font-weight:normal;"
...
def _create_analysis_chart_block(
    ...
    *,
    ...
    title_label = QLabel("")
    title_label.setFont(make_app_font(10, bold=True))
    ...
    value_label = QLabel("")
    value_label.setFont(make_app_font(CHART_AXIS_LABEL_FONT_PT))
    ...
    footer_label.setFont(
        make_app_font(CHART_REFINED_TICK_FONT_PT)
        if footer_style_sheet is not None
        else make_app_font(CHART_AXIS_LABEL_FONT_PT)
    )
...
def _create_price_structure_chart_block(
    ...
    *,
    ...
    legend_label.setFont(make_app_font(CHART_REFINED_TICK_FONT_PT))
...
def _paint_chart_x_axis_dates(
    ...
    *,
    ...
    if n < 2:
        return
    p.setFont(axis_font if axis_font is not None else _chart_font_axis())
...
def _chart_font_axis():
    ...
    return make_app_font(CHART_AXIS_LABEL_FONT_PT)


def _chart_font_axis_refined():
    """1·3번 차트 축: 8pt (스펙 #A0AEC0는 펜 색으로 별도 지정)."""
    return make_app_font(CHART_REFINED_TICK_FONT_PT)
...
class SimpleTrendChartWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        p.setFont(_chart_font_axis_refined())
        fm_ax = p.fontMetrics()
...
class RealtimeAuctionPage(QWidget):
    ...
    def __init__(self, owner: "MarketPricePage", parent=None):
        ...
        title.setFont(make_app_font(13, bold=True))
        title.setStyleSheet(MainStyles.CARD_LBL_STYLE + " color:#2D3748;")
        ...
        self.btn_search.setFont(make_app_font(10, bold=True))
        ...
        self.lbl_status.setStyleSheet(
            f"color:#718096;border:none;background:transparent;padding:0px;margin:0px;"
            f"font-family:'{DEFAULT_FONT_FAMILY}';font-size:10pt;"
        )
...
class SettlementPage(QWidget):
    ...
    def __init__(self, owner: "MarketPricePage", parent=None):
        ...
        self.lbl_status.setFont(make_app_font(9))
        self.lbl_status.setStyleSheet("color:#718096;border:none;background:transparent;")
        ...
        if DEBUG_MARKET_VERIFY:
            ...
            self.lbl_debug_info.setFont(make_app_font(8))
            self.lbl_debug_info.setStyleSheet("color:#8A94A6;border:none;background:transparent;")
...
class MarketPricePage(DashboardDetailBase):
    ...
    def _create_section_card(self, title: str, subtitle: str = ""):
        ...
        title_lbl.setFont(make_app_font(13, bold=True))
        title_lbl.setStyleSheet(MainStyles.CARD_LBL_STYLE + " color:#2D3748;")
        layout.addWidget(title_lbl)

        if subtitle:
            sub_lbl = QLabel(subtitle)
            sub_lbl.setFont(make_app_font(10))
            sub_lbl.setStyleSheet("color:#718096; background: transparent; border: none;")
    ...
    def _build_section_market_analysis_placeholder(self):
        ...
        self.btn_market_analysis_fetch.setStyleSheet(MainStyles.BTN_SECONDARY)
        self.btn_market_analysis_fetch.setFont(make_app_font(10, bold=True))
        self.btn_market_analysis_fetch.setFixedHeight(FILTER_CONTROL_HEIGHT)
        ...
        self.btn_market_analysis_reset.setStyleSheet(MainStyles.BTN_SECONDARY)
        self.btn_market_analysis_reset.setFont(make_app_font(10))
        self.btn_market_analysis_reset.setFixedHeight(FILTER_CONTROL_HEIGHT)
        ...
        self.btn_market_analysis_verify_popup.setStyleSheet(MainStyles.BTN_SECONDARY)
        self.btn_market_analysis_verify_popup.setFont(make_app_font(10))
        self.btn_market_analysis_verify_popup.setFixedHeight(FILTER_CONTROL_HEIGHT)
        ...
        if DEBUG_MARKET_VERIFY:
            ...
            self.btn_download_verify.setStyleSheet(MainStyles.BTN_SECONDARY)
            self.btn_download_verify.setFont(make_app_font(10))
            self.btn_download_verify.setFixedHeight(FILTER_CONTROL_HEIGHT)
        ...
        self.lbl_market_analysis_status.setFont(make_app_font(9))
        ...
        self.lbl_market_analysis_latest.setFont(make_app_font(9))
        ...
        lbl_pan_title.setFont(make_app_font(9))
        lbl_pan_title.setStyleSheet("color:#718096; border:none; background:transparent;")
        ...
        def _metric_pair(key: str, default: str):
            ...
            hl.setSpacing(0)
            lk = QLabel(key)
            lk.setFont(make_app_font(9))
            lk.setStyleSheet("color:#718096; border:none; background:transparent;")
            lv = QLabel(default)
            lv.setFont(make_app_font(9, bold=True))
            lv.setStyleSheet("color:#4A5568; border:none; background:transparent;")
        ...
        self.lbl_analysis_signal_hint.setFont(make_app_font(7))
        self.lbl_analysis_signal_hint.setStyleSheet("color:#A0AEC0; border:none; background:transparent;")
        ...
        lbl_pt = QLabel("가격 기준:")
        lbl_pt.setFont(make_app_font(9))
        lbl_pt.setStyleSheet("color:#4A5568; border:none; background:transparent;")
