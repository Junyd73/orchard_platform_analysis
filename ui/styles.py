...
class MainStyles:
    ...
    MAIN_BG = (
        "background-color: #FDFBF7; font-family: 'Malgun Gothic'; font-size: 11px;"
    )
    ...
    """ 
    BTN_SUCCESS = "background-color: #27AE60; color: white; font-size: 12px; font-weight: bold; border-radius: 6px; padding: 5px 12px;"
    ...
    INPUT_TOTAL = """
        QLineEdit {
            font-size: 12px;        /* 10px은 너무 작을 수 있어 12px로 추천드려요! */
    ...
    # 8. 라벨 텍스트 스타일
    LBL_TITLE = "font-size: 15px; font-weight: bold; color: #2D5A27; border: none;"
    LBL_GRID_HEADER = " font-size: 12px; font-weight: bold; color: #444; border: none; background: transparent;"  
    LBL_SUB = "font-size: 11px; color: #777; border: none; qproperty-alignment: 'AlignCenter'; margin-bottom: 2px;"
    LBL_TABLE_SUB = "font-size: 12px; background: transparent; color: #4A5568; font-weight: bold; padding: 4px; border-radius: 3px; border: none;"
    LbL_HIGHTLIGHT = "font-size: 13px; color: #27AE60; font-weight: bold; margin-left: 10px; "
    LBL_TEXT_LEFT_LIGHT = " font-size: 13px; font-weight: bold; color: #444; border: none; background: transparent; qproperty-alignment: 'AlignLeft';"  
    LBL_TEXT_RIGHT_LIGHT = " font-size: 13px; font-weight: bold; color: #444; border: none; background: transparent; qproperty-alignment: 'AlignRight';"  
    LBL_TEXT_CENTER_LIGHT = " font-size: 13px; font-weight: bold; color: #444; border: none; background: transparent; qproperty-alignment: 'AlignCenter';"  
    LBL_DATE = "font-size: 12px; font-weight: bold; color: #333; border: none;"
    LBL_DASH_UNPAID = "font-size: 18px; color: #D32F2F; font-weight: bold; border: none; background: transparent;"
    ...
    # 규격별 텍스트 색상 가이드
    AI_TEXT_NORMAL = "font-size: 12px; color: #2D3748; font-weight: bold;"
    AI_TEXT_LOSS = "font-size: 12px; color: #E53E3E; font-weight: normal;"
