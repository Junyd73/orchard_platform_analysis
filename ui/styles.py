...
class MainStyles:
    ...
    PAGE_LBL_TITLE = "font-size: 14px; font-weight: bold; color: #2D5A27; border: none;"
    # 영농일지 작성: 상단 대제목(강조) vs 카드/탭 내 구역 제목(상대적으로 작게)
    WORK_LOG_PAGE_TITLE = (
        "font-size: 14px; font-weight: bold; color: #2D5A27; border: none;"
    )
    WORK_LOG_SECTION_TITLE = (
        "font-size: 12px; font-weight: bold; color: #444; border: none;"
    )
    # 영농일지 월간정보 — 상태색·카드·캘린더 (화면 하드코딩 금지)
    WORK_LOG_CAL_HAS_WORK_BG = "#F1F8F2"       # 작업 있음(아주 연한 녹색)
    WORK_LOG_CAL_IN_PROGRESS_BG = "#FFF8F0"    # 진행 중(아주 연한 주황)
    WORK_LOG_CAL_TODAY_BORDER = "#3182CE"      # 오늘
    WORK_LOG_CAL_SELECTED_BORDER = "#2D5A27"   # 선택 날짜(딥그린)
    WORK_LOG_CAL_ISSUE_DOT = "#E53E3E"         # 이슈(work_rmk) 점
    WORK_LOG_CAL_CELL_TEXT = "#2D3748"
    WORK_LOG_CAL_MUTED_TEXT = "#A0AEC0"       # 타월·미래 날짜
    WORK_LOG_CAL_SAT_TEXT = "#2B6CB0"         # 토요일
    WORK_LOG_CAL_SUN_TEXT = "#C53030"         # 일요일
    WORK_LOG_CAL_GRID = "#EAE7E2"
    WORK_LOG_CAL_WEEKDAY_HEADER_BG = "#F8F9FA"
    WORK_LOG_MONTHLY_YM_TITLE = (
        "font-size: 16px; font-weight: bold; color: #2D5A27; border: none; "
        "background: transparent; padding: 0 12px;"
    )
    # 관찰일지 심각도 행 배경 (과도한 원색 지양)
    OBS_SEVERITY_BG = {
        "OS010100": "#E8F5E9",  # 정상
        "OS010200": "#FFF8E1",  # 관심
        "OS010300": "#FFF3E0",  # 주의
    ...
    # 관찰 캘린더 점·재관찰 표시색
    OBS_CAL_DOT_NORMAL = "#2D5A27"
    OBS_CAL_DOT_WATCH = "#D69E2E"
    OBS_CAL_DOT_CAUTION = "#DD6B20"
    OBS_CAL_DOT_DANGER = "#C53030"
    OBS_CAL_FOLLOWUP_DUE = "#3182CE"
    OBS_CAL_FOLLOWUP_OVERDUE = "#9B2C2C"
    OBS_SUMMARY_CARD = """
        QFrame#ObsSummaryCard {
            background-color: white;
            border: 1px solid #EAE7E2;
            border-radius: 12px;
            min-width: 72px;
        }
        QFrame#ObsSummaryCard:hover {
            border: 1px solid #C6F6D5;
            background-color: #F7FAFC;
        }
        QFrame#ObsSummaryCard[selected="true"] {
            border: 2px solid #2D5A27;
            background-color: #F0FFF4;
        }
        QLabel#ObsSummaryTitle {
            font-size: 10px;
            font-weight: bold;
            color: #4A5568;
            border: none;
    ...
    """
    WORK_LOG_MONTHLY_SUMMARY_CARD = """
        QFrame#WorkLogMonthlySummaryCard {
            background-color: white;
            border: 1px solid #EAE7E2;
            border-radius: 12px;
            min-width: 120px;
        }
        QLabel#WorkLogMonthlySummaryTitle {
            font-size: 10px;
            font-weight: bold;
            color: #4A5568;
            border: none;
        ...
        QLabel#WorkLogMonthlySummaryValue {
            font-size: 15px;
            font-weight: bold;
            color: #2D5A27;
            border: none;
    ...
    """
    WORK_LOG_MONTHLY_CAL_CARD = """
        QFrame#WorkLogMonthlyCalCard {
            background-color: white;
            border: 1px solid #EAE7E2;
            border-radius: 12px;
        }
    """
    WORK_LOG_MONTH_CALENDAR = """
        QCalendarWidget {
            background-color: transparent;
            border: none;
        }
