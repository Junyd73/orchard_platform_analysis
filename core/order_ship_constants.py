...
# S4A — 무주문 직접판매 분류
MSG_DIRECT_SALES_TYPE_REQUIRED = "판매유형을 선택해 주세요."
MSG_DIRECT_SALES_TYPE_INVALID = "올바른 판매유형이 아닙니다."
MSG_DIRECT_SALES_CATEGORY_REQUIRED = "판매구분을 선택해 주세요."
MSG_DIRECT_SALES_CATEGORY_INVALID = "직접판매에서 사용할 수 없는 판매구분입니다."
CODE_DIRECT_SALES_TYPE_REQUIRED = "DIRECT_SALES_TYPE_REQUIRED"
CODE_DIRECT_SALES_TYPE_INVALID = "DIRECT_SALES_TYPE_INVALID"
CODE_DIRECT_SALES_CATEGORY_REQUIRED = "DIRECT_SALES_CATEGORY_REQUIRED"
CODE_DIRECT_SALES_CATEGORY_INVALID = "DIRECT_SALES_CATEGORY_INVALID"
